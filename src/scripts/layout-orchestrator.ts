...
// Owner command: scripts.orchestrator.generate
// Edit instead: the scripts.orchestrator.generate generator source (not this file).
// Regenerate:   pnpm exec werkstatt run scripts.orchestrator.generate --site forge-warpgogol
/*
<MODULE_CONTRACT>
