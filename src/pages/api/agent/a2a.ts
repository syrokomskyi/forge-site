...
// Section-owned Agent Gate route (RFC-1114). Handler logic lives once in
...
import { createAgentA2aRoute } from "@warpgogol/werkstatt-engine/agent-gate/astro";

const route = createAgentA2aRoute(agentSurfaceManifest as never, agentCapabilities as never);
