...
// Edit instead: packages/werkstatt/src/kernel/templates/wire/tools/modules/pipelines.module.template.ts
// Regenerate:   pnpm exec werkstatt run kernel.wire --site forge-warpgogol
/*
<MODULE_CONTRACT>
<purpose>Pipelines module for forge-warpgogol — declares site-level build and check pipelines as ModuleExport.pipelines (RFC-1038).</purpose>
<non-goals>
