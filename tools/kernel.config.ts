...
// Edit instead: packages/werkstatt/src/kernel/templates/wire/tools/kernel.config.template.ts
// Regenerate:   pnpm exec werkstatt run kernel.wire --site forge-warpgogol
/*
<MODULE_CONTRACT>
<purpose>Kernel configuration for forge-warpgogol — declares modules and pipelines.</purpose>
<non-goals>
...
export default defineKernelConfig({
  name: "forge-warpgogol",
  description: "forge-warpgogol Astro site OS",
  moduleLoaders: {
